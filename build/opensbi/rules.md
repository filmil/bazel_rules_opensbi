...
<pre>
load("@rules_opensbi//build/opensbi:rules.bzl", "opensbi_library")
...
<pre>
load("@rules_opensbi//build/opensbi:rules.bzl", "OpenSbiFirmwareInfo")
...
<pre>
load("@rules_opensbi//build/opensbi:rules.bzl", "OpenSbiInfo")
